package mathlib.calculus;

import mathlib.polynomial.Polynomial;
...
public class Integral {
    ...
    public double definite(Polynomial p, int lowerLimit, int upperLimit){
        Polynomial i = indefinite(p);
        return i.value(upperLimit) - i.value(lowerLimit);
    }
