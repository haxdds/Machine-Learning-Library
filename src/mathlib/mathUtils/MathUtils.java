...
public class MathUtils {
    ...
    //returns number of combinations given set size n and group size k
    public static long combinations(long n, long k){
        return factorial(n) / (factorial(k) * factorial(n-k));
    }
    //returns number of permutations given set size n and group size k
    public static long permuations(long n, long k){
